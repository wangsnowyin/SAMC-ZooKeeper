...
public class Create2Request implements Record {
  private String path;
  private byte[] data;
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    throw new UnsupportedOperationException("comparing Create2Request is unimplemented");
  }
  public boolean equals(Object peer_) {
    if (!(peer_ instanceof Create2Request)) {
      return false;
    }
    if (peer_ == this) {
      return true;
    }
    Create2Request peer = (Create2Request) peer_;
    boolean ret = false;
  ...
  public static String signature() {
    return "LCreate2Request(sB[LACL(iLId(ss))]i)";
  }
}
